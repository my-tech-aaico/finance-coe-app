              ...
              <tbody className="divide-y divide-surface-100">
                {users.map((u) => (
                  <tr key={u.id} className="table-row">
                    ...
                    <td className="px-5 py-4 text-surface-500">{u.email}</td>
                    <td className="px-5 py-4">
                      <span
                        className={`badge justify-center ${ROLE_COLORS[u.role] ?? ""}`}
                    ...
                    <td className="px-5 py-4">
                      <span
                        className={`badge justify-center ${STATUS_COLORS[u.status] ?? ""}`}
                        style={{ textTransform: "capitalize" }}
                      >
                        {u.status}
                      </span>
